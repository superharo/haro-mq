...
public class TopicConsumer2 {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        //设置队列
        channel.queueDeclare(TopicQueue.HARO_TEST2_TOPIC_QUEUE_NAME,false,false,false,null);
        //绑定路由键
        String routeKey ="haro_topic.#";
        channel.queueBind(TopicQueue.HARO_TEST2_TOPIC_QUEUE_NAME,TopicExChange.name,routeKey);
        //声明消费者
        ...
        //消费者绑定队列消费 (自动提交)
        channel.basicConsume(TopicQueue.HARO_TEST2_TOPIC_QUEUE_NAME,true,consumer);
    }
